...
if (isset($_POST['ordersubmit'])) {
    if (strlen($_SESSION['login']) == 0) {
        ...
        unset($_SESSION['cart']);
        unset($_SESSION['tp']); // Assuming this variable stores the total price
				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="detail.html">
						    <img src="admin/productimages/<?php echo $row['id'];?>/<?php echo $row['productImage3'];?>" alt="" width="114" height="146">
						</a>
					</td>
