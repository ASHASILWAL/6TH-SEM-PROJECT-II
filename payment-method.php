		...
		<div class="checkout-box faq-page inner-bottom-sm">
			<div class="row">
				<div class="col-md-12">
					...
					<div class="panel-group checkout-steps" id="accordion" height="30px">
						<!-- checkout-step-01  -->
<div class="panel panel-default checkout-step-01">
	...
	<!-- panel-heading -->
    	...
    	<h4 class="unicase-checkout-title">
	        <a data-toggle="collapse" class="" data-parent="#accordion" href="#collapseOne">
	         Pay Your Bills Using Below Button
	        </a>
	     </h4>
    </div>
    <!-- panel-heading -->
	...
	<div id="collapseOne" class="panel-collapse collapse in">
		...
		<button>
    <a href="#" data-amount=30 id='payment-button-1' class="btn btn-primary pay-khalti" style="font-size:18px;" >Pay with Khalti</a>
</button>

<div class="btn btn-primary" style="margin-left:890px; margin-top:1px; font-size:18px;">
<button>
    <a href="order-history.php" >Your Order History</a>
</button>
</div>
		</div>
		<!-- panel-body  -->
...
<!-- checkout-step-01  -->
					...
					<!-- <div class="btn btn-primary" style="margin-left:890px; margin-top:1px; font-size:18px;">
<button>
    <a href="generate-bill.php" >Generate Bill</a>
</button>
</div> -->
				</div>
			</div><!-- /.row -->
