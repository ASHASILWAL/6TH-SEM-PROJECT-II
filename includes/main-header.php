...
?>
<!-- style = "position: fixed; width: 100%; z-index: 1000;background-color: white;" -->
...
<div class="search-area">
    <form name="search" method="get" action="search-result.php">
			...
			<li>
				<div class="cart-item product-summary">
					<div class="row">
						<div class="col-xs-4">
							<div class="image">
								<a href="product-details.php?pid=<?php echo $row['id'];?>"><img  src="admin/productimages/<?php echo $row['id'];?>/<?php echo $row['productImage3'];?>" width="35" height="50" alt=""></a>
							</div>
						</div>
						<div class="col-xs-7">
...
<!-- ============================================================= SHOPPING CART DROPDOWN : END============================================================= -->				</div><!-- /.top-cart-row -->
    ...
    .main-header {
        position: fixed;
        top: 50px; /* Adjust top position based on the height of the top-bar */
        width: 100%;
        z-index: 1000;
