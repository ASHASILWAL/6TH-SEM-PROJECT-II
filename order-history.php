...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function cancelOrder(orderId) {
            ...
            var userConfirmation = confirm("If you cancel this order you get refund but 5% deduction from your paid amount please contact us for refund....Are you sure you want to cancel this order?");

            if (userConfirmation) {
                // If user confirms, perform cancellation action
        ...
        <div class="row inner-bottom-sm">
			...
			<tbody>
					...
					<td>
                                            ...
                                            <a href="javascript:void(0);" onClick="cancelOrder(<?php echo $row['orderid']; ?>);" title="Cancel order">Cancel</a>
                                        </td>
                                    </tr>
                                    <?php $cnt=$cnt+1;} ?>
                                </tbody>
					...
					<div class="btn btn-primary" style="margin-left:890px; margin-top:1px; font-size:18px;">
<button>
    <a href="bill.php" >Generate Order History Statement</a>
</button>
</div>
                </div>
            </div>
